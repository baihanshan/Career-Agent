...
class ReActErrorCode(StrEnum):
    REACT_MODEL_UNAVAILABLE = "REACT_MODEL_UNAVAILABLE"
    REACT_TOOL_CALL_ERROR = "REACT_TOOL_CALL_ERROR"
    REACT_RECURSION_LIMIT_ERROR = "REACT_RECURSION_LIMIT_ERROR"
    REACT_OUTPUT_PARSE_ERROR = "REACT_OUTPUT_PARSE_ERROR"
...
class WorkflowErrorCode(StrEnum):
    ...
    PUBLIC_OUTPUT_GATE_ERROR = "PUBLIC_OUTPUT_GATE_ERROR"
